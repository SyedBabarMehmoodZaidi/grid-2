...
const Grid = () => {
  return (
    <main className='grid grid-cols-6 grid-rows-5 h-screen gap-2 p-4'>
      ...
      <div className='bg-orange-600 text-white flex justify-center items-center row-span-2 '>Right Side Bar</div>
